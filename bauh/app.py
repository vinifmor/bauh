...
from bauh.view.qt.updates import UpdatesPanel
...
component_manager = PythonComponentsManager(context=context, github_client=GitHubClient(logger))
updates = component_manager.list_updates()
...
if updates:
    UpdatesPanel(component_manager, updates, i18n).show()
else:
