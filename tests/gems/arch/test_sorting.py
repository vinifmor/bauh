...
class SortingTest(TestCase):
    ...
    def test__sort__aur_not_related(self):
        pkgs = {'google-chrome': {'d': {'alsa-lib', 'gtk3', 'libcups'}, 'p': {'google-chrome': 'google-chrome'}, 'r': 'aur'},
                'git-cola': {'d': {'git', 'python-pyqt5', 'icu qt5-svg'}, 'p': {'git-cola': 'git-cola'}, 'r': 'aur'},
                'kazam': {'d': {'python', 'python-cairo'}, 'p': {'kazam': 'kazam'}, 'r': 'aur'}}
    ...
    def test__sort__all_packages_no_deps(self):
        pkgs = {'xpto': {'d': set(), 'p': {'xpto': 'xpto'}, 'r': 'extra'},
                'abc': {'d': None, 'p': {'abc': 'abc'}, 'r': 'aur'}}
    ...
    def test__sort__one_of_three_related(self):
        pkgs = {'def': {'d': {'jkl'}, 'p': {'def': 'def'}, 'r': 'extra'},
                'abc': {'d': {'ghi', 'xpto'}, 'p': {'abc': 'abc'}, 'r': 'aur'},
    ...
    def test__sort__two_of_three_related(self):
        """
    ...
    def test_sorting__pkg_should_be_after_its_latest_dependency(self):
        pkgs = {'abc': {'d': {'def', 'ghi'}, 'p': {'abc': 'abc'}, 'r': 'community'},
                'ghi': {'d': {'xpto'}, 'p': {'ghi': 'ghi'}, 'r': 'aur'},
                'xpto': {'d': {'zzz'}, 'p': {'xpto': 'xpto'}, 'r': 'extra'},
                'def': {'d': None, 'p': {'def': 'def'}, 'r': 'aur'}}
    ...
    def test__sort__two_relying_on_the_same_package(self):
        """
            dep order:
                abc -> ghi
                jkl -> ghi
    ...
    def test__sort__with_cycle(self):
        """
            dep order:
                abc -> def -> ghi -> jkl -> abc
        """
        pkgs = {'def': {'d': {'ghi'}, 'p': {'def': 'def'}, 'r': 'extra'},
                'abc': {'d': {'def'}, 'p': {'abc': 'abc'}, 'r': 'aur'},
                'ghi': {'d': {'jkl'}, 'p': {'ghi': 'ghi'}, 'r': 'extra'},
                'jkl': {'d': {'abc'}, 'p': {'jkl': 'jkl'}, 'r': 'aur'}}
    ...
    def test__sort__dep_provided_as_a_different_name(self):
        """
            dep order:
                abc -> fed
                def (fed)
